...
Voluntary environmental instruments has been used increasingly in the UK since the 1990s, including as part of a wider trend towards 'better regulation' (NAO, 2014). A key motivation for their use is achieving sought outcomes without the need for additional regulation, and in some cases sidestepping inertia that can be associated with the policy-making process. Voluntary approaches can be introduced as an alternative to regulation or as a supplement to it (Delmas and Terlaak, 2002). There are examples of voluntary approaches achieving positive change in the UK in relation to CE objectives and those wider, suggesting these can be made to work when well-designed and targeted ([OECD, 1999](https://www.oecd-ilibrary.org/environment/voluntary-approaches-for-environmental-policy_9789264180260-en)). Voluntary approaches can help address regulatory and data gaps - in some cases with rapidity - and help encourage beyond-compliance improvements to deliver positive net-benefits (Wrap, 2023).

While effective design and coordination can overcome some barriers to voluntary action, the effectiveness of voluntary approaches can be curtailed by economic limits to voluntarism along with a lack of enforceable commitments and scope for non-interaction or free-riding. A willingness to refrain from regulatory approaches in favour of those voluntary may run the risk of reducing government negotiating power in delivering objectives ([Rennings *et al.* 1997](https://www.econstor.eu/bitstream/10419/29409/1/227844114.pdf)). Voluntary approaches should be viewed as a useful complement in a policy mix for CE-related change when well-designed and in the right context (these conditions are further explored here), but not be relied upon solely nor replace existing regulations.
:::

# How it works and current applications

Voluntary approaches can be defined as: public or private efforts to improve environmental performance in the absence of a binding legal mandate[^1] and be categorised into (Paton, 2001; OECD, 2003):

[^1]: This is not to say that government is not involved however. 40 voluntary environmental programs in the building sector in Australia, the Netherlands, Singapore and the US, were found to involve governments in nearly (95%) of these (van der Heijden, 2015).

::: {.callout-note collapse="true" appearance="simple" icon="false"}
## Unilateral initiatives

Involving actions within a single firm that can be expanded through e.g. supply-chain integration (where firms require suppliers to subscribe to similar practices) as well as household voluntary action like purchasing offsets.
:::

::: {.callout-tip collapse="true" appearance="simple" icon="false"}
## Voluntary industry standards

Private codes of conduct to improve firm performance promoted by standardisation or non-governmental organisations e.g. the ISO 14000 environmental management system series or the European-level Eco-Management and Audit Scheme (EMAS).
:::

::: {.callout-important collapse="true" appearance="simple" icon="false"}
## Public voluntary challenges

Programmes promoted or supported by public authorities which encourage firms, households or other institutional actors to improve environmental performance. For example, London's Food Purchasing Commitment 'developed by ReLondon, London borough of Hackney and Sustain: The alliance for better food and farming, in collaboration with a Working Group of 21 #Londonboroughs, and as part of London Councils' One World Living programme to reduce the climate impact of London's food system' ([ReLondon, 2023](https://relondon.gov.uk/latest/hackney-hounslow-lambeth-and-newham-councils-pave-the-way-in-londons-food-system-transformation)). Alternatively, proposed voluntary food waste reporting by Defra.
:::

::: {.callout-caution collapse="true" appearance="simple" icon="false"}
## Voluntary agreements

Contractual or non-binding agreements developed through dialogue between public authorities or voluntary groups on one hand, and firms on the other to achieve certain objectives ([Defra, 2018](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/765915/rws-evidence-annex.pdf)). Examples include the UK Plastics Pact and Textiles 2030 brokered by Wrap, as well as 'climate change agreements' made between industry and the Environment Agency to reduce energy use and CO2 emissions.
:::
...
-   Scotland's SEPA has a programme of Sustainable Growth Agreements (SGAs) - formal voluntary agreements between SEPA and (an) organisation(s) focussing on delivering 'environmentally positive outcomes' ([SEPA,](https://www.sepa.org.uk/one-planet-prosperity/sustainable-growth-agreements/))[^2];
...
[^2]: Though the SGA principles emphasise these augmenting rather than replacing SEPA's regulatory work ([SEPA,](https://www.sepa.org.uk/media/286873/sga_guiding_principals.pdf))
...
-   VAs may work best as part of a policy package, rather than as a stand-alone instrument (Krarup and Ramesohl, 2002; Torvanger and Skodvin, 2002).
